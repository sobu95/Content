        ...
        async function viewPromptDetails(logId) {
            ...
            try {
                ...
                if (data.error) {
                    ...
                    html += '<pre class="bg-light p-3" style="max-height: 400px; overflow-y: auto;">' + data.prompt_content + '</pre>';
                    html += '</div>';
                    html += '<div class="col-md-6">';
                    html += '<h6>Odpowiedź API:</h6>';
                    if (data.api_response) {
                        html += '<div class="bg-light p-3" style="max-height: 400px; overflow-y: auto;">' + data.api_response + '</div>';
                    } else {
